...
- [ ] Domain. `which.tools` and `whichcodingtool.com` were free on 2026-08-23. Then set `NUXT_SITE_URL`, and consider `site: { indexable: false }` until the switch so Google doesn't learn the vercel.app URL.
