...
export default defineEventHandler(async (event) => {
  ...
  const paths = new Set<string>(['/', '/compare', '/llms.txt', '/llms-full.txt', '/sitemap.xml', '/sitemap.md', `${API_BASE}/tools.json`, `${API_BASE}/compare.json`, '/api/content/list', '/api/__sitemap__/urls'])
