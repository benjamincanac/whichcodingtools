...
export default defineEventHandler(async (event) => {
  ...
  const paths = new Set<string>(['/', '/changes', '/changes.xml', '/compare', '/llms.txt', '/llms-full.txt', '/sitemap.xml', '/sitemap.md', '/api/tools.json', '/api/changes.json', '/api/content/list', '/api/__sitemap__/urls'])
